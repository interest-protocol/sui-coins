...
const XCirlce: FC<SVGProps> = ({ maxWidth, maxHeight, ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="M9 7.58579L12 10.5858L15 7.58579L16.4142 9L13.4142 12L16.4142 15L15 16.4142L12 13.4142L9 16.4142L7.58579 15L10.5858 12L7.58579 9L9 7.58579Z" fill="currentColor"/>
